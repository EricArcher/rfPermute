...
#' @description Combine plots of error traces, out-of-bag (OOB) rates, and inbag 
#'   (for classification models) rates.
#'
#' @param object a \code{rfPermute} or \code{randomForest} model object to 
#'   summarize.
#' @param ... arguments passed to \code{\link{plotBag}}.
#'   
#' @return A combination of plots from \code{\link{plotTrace}} and 
#'   \code{\link{plotBag}} as well as summary confusion matrices 
#'   (classification) or error rates (regression) from the model.
#'  
#' @seealso \code{\link{plotTrace}}, \code{\link{plotBag}}  
#' 
...
summary.rfPermute <- function(object, ...) {
  summary(as.randomForest(object), ...)
}